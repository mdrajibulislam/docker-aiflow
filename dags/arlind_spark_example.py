...
awsAccessKeyId = Variable.get("arlind_aws_access_key")
awsSecretAccessKey = Variable.get("arlind_aws_secret_key")
process_data_cmd = """set -e
                    ...
                    """.format(spark_folder_path='/var/volshares/airflow/dags/helper/spark/',
                               ...
                               s3_input_path='s3n://arlind-sf-ingest/sale-data/csv/customers_v2.csv',
                               s3_output_path='s3n://arlind-sf-data/sale-data/json/state_by_customer/')
